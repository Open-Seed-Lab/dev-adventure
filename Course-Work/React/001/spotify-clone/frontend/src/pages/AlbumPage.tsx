...
const AlbumPage = () => {
	...
	const handlePlayAlbum: MouseEventHandler<HTMLButtonElement> = () => {
	...
	return <main className='rounded-md overflow-hidden h-full bg-gradient-to-b from-zinc-800 to-zinc-900'>
